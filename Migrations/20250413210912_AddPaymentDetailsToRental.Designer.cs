...
namespace CarRental3._0.Migrations
{
    ...
    [Migration("20250413210912_AddPaymentDetailsToRental")]
    partial class AddPaymentDetailsToRental
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarRental3._0.Models.Car", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Brand = "Toyota",
                            Category = 0,
                            CreatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5697),
                            DailyRate = 30m,
                            ImagePath = "https://global.toyota/pages/models/images/camry/camry_010_s.jpg",
                            LocationId = 1,
                            Model = "Camry",
                            Status = "В наличност",
                            UpdatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5698),
                            Year = 2024
                        },
                        new
                        {
                            ...
                            Brand = "Toyota",
                            Category = 0,
                            CreatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5699),
                            DailyRate = 40m,
                            ImagePath = "https://di-uploads-pod3.dealerinspire.com/riversidetoyota/uploads/2018/12/2019-Toyota-Corolla-L-123118-copy.png",
                            LocationId = 3,
                            Model = "Corolla",
                            Status = "В наличност",
                            UpdatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5699),
                            Year = 2023
                        },
                        new
                        {
                            ...
                            Brand = "Ford",
                            Category = 2,
                            CreatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5702),
                            DailyRate = 60m,
                            ImagePath = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQle7rOjsAdhTfpggSwLzKnflAShadVzCWb7Q&s",
                            LocationId = 2,
                            Model = "Transit",
                            Status = "В наличност",
                            UpdatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5702),
                            Year = 2022
                        },
                        new
                        {
                            ...
                            Brand = "BMW",
                            Category = 1,
                            CreatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5766),
                            DailyRate = 120m,
                            ...
                            Model = "X5",
                            Status = "В наличност",
                            UpdatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5766),
                            Year = 2023
                        },
                        new
                        {
                            ...
                            Brand = "Volkswagen",
                            Category = 2,
                            CreatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5768),
                            DailyRate = 110m,
                            ...
                            Model = "Transporter",
                            Status = "В наличност",
                            UpdatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5769),
                            Year = 2013
                        },
                        new
                        {
                            ...
                            Brand = "Audi",
                            Category = 1,
                            CreatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5771),
                            DailyRate = 90m,
                            ...
                            Model = "A4",
                            Status = "В наличност",
                            UpdatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5772),
                            Year = 2022
                        },
                        new
                        {
                            ...
                            Brand = "Audi",
                            Category = 1,
                            CreatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5774),
                            DailyRate = 130m,
                            ...
                            Model = "A6",
                            Status = "В наличност",
                            UpdatedAt = new DateTime(2025, 4, 13, 21, 9, 9, 461, DateTimeKind.Utc).AddTicks(5774),
                            Year = 2023
                        });
                });
